...
import { NextAppRouterWebhookHandler, WebhookConfig } from "./saleor-webhook";

const webhookPath = "api/webhooks/product-updated";
const baseUrl = "https://example.com";

describe("Next App Router SaleorAsyncWebhook", () => {
  ...
  describe("createHandler", () => {
    ...
    it("should allow overriding error responses using formatErrorResponse", async () => {
      ...
      const request = new NextRequest(`${baseUrl}/webhook`, {
        method: "POST",
